...
if __name__ == "__main__":
    ...
    # -- PLANILHA 2015
    # ----------------------------------------------------------
    pla_2015_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2015-01.csv", sep=";")
    pla_2015_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2015-02.csv", sep=";")
    ...
    # pla_2015_comp = pd.read_csv(r'C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\novo.csv', sep=',')
    ...
    # -- PLANILHA 2016
    # ----------------------------------------------------------
    # pla_2016_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2016-01.csv", sep=";")
    # pla_2016_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2016-02.csv", sep=";")
    ...
    # # -- PLANILHA 2017
    # # ----------------------------------------------------------
    # pla_2017_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2017-01.csv", sep=";")
    # pla_2017_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2017-02.csv", sep=";")
    ...
    # -- PLANILHA 2018
    # ----------------------------------------------------------
    pla_2018_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2018-01.csv", sep=";")
    pla_2018_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2018-02.csv", sep=";")
    ...
    # -- PLANILHA 2019
    # ----------------------------------------------------------
    # pla_2019_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2019-01.csv", sep=";")
    # pla_2019_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2019-02.csv", sep=";")
    ...
    # # pla_2019_comp = pd.read_csv(r'C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\novo.csv', sep=',')
    # con = mysql.connector.connect(user='root', password='Eugostode@55', host='localhost', database='consumo_combustivel')
    # cursor = con.cursor()
    ...
    # # -- PLANILHA 2020
    # # ----------------------------------------------------------
    # pla_2020_1 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2020-01.csv", sep=";")
    # pla_2020_2 = pd.read_csv(r"C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\ca-2020-02.csv", sep=";")
    ...
    # # pla_2020_comp = pd.read_csv(r'C:\Users\isa66\Desktop\Visualcode\.vscode\Atividade_de_natal\novo.csv', sep=',')
    # con = mysql.connector.connect(user='root', password='Eugostode@55', host='localhost', database='consumo_combustivel')
    # cursor = con.cursor()
